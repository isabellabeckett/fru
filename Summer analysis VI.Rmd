...
```{r}
png(file= "~/Documents/Greg Jefferis' lab/fru/network_female_o_frutofru.png",
...
```{r}
png(file= "~/Documents/Greg Jefferis' lab/fru/network_female_i_frutofru.png",
width=3000, height=3000)
...
```{r}
png(file= "~/Documents/Greg Jefferis' lab/fru/network_male_o_frutofru.png",
width=3000, height=3000)
...
```{r}
png(file= "~/Documents/Greg Jefferis' lab/fru/network_male_i_frutofru_scheme.png",
width=3000, height=3000)

network3 <- graph_from_adjacency_matrix(MCNS_adj2, mode = "directed", weighted = TRUE, diag = FALSE)
